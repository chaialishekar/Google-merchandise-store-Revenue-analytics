...
| Unit economics | Is the customer worth acquiring? | LTV = $89.07 (real); CAC illustrative only | LTV:CAC and payback shown as a labeled example, not a measured result |
